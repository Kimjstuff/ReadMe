...
Teacher underviser = new Teacher("Thorbjørn", 40, false);
Student elev1 = new Student("Kim",32,false,"HoldB");
Student elev2 = new Student("Jens",32,false,"HoldB");

System.out.println(underviser.name);
System.out.println(elev1.name+" "+elev1.datamatikerTeam);
System.out.println(elev2.name+" "+elev2.datamatikerTeam);
